...
CREATE POLICY "Team members can view team members" ON "public"."team_members" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."team_members" "team_members_1"
  WHERE (("team_members_1"."team_id" = "team_members_1"."team_id") AND ("team_members_1"."user_id" = "auth"."uid"())))));
